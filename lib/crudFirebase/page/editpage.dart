...
@override
  void initState() {
    ...
    _employee_name.value = TextEditingValue(text: widget.task!.taskname.toString());
    _employee_position.value = TextEditingValue(text: widget.task!.taskdetail.toString());
    _employee_contact.value = TextEditingValue(text: widget.task!.status.toString());
  }
  ...
  Widget build(BuildContext context) {
        ...
        onPressed: () async {
          if (_formKey.currentState!.validate()) {
            var response = await FirebaseCrud.updateEmployee(
                taskname: _employee_name.text,
                taskdetail: _employee_position.text,
                status: _employee_contact.text,
                docId: _docid.text);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Task CRUD Edit'),
